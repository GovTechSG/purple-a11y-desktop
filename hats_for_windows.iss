...
[Icons]
Name: "{autoprograms}\Purple HATS Desktop"; Filename: "{app}\Purple HATS Frontend\chrome.exe"
Name: "{autodesktop}\Purple HATS Desktop"; Filename: "{app}\Purple HATS Frontend\chrome.exe"; Tasks: desktopicon
